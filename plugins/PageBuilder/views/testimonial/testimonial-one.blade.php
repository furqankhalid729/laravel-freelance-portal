...
<section class="testimonial-area section-bg-1 pat-100 pab-100" data-padding-top="{{$padding_top ?? ''}}" data-padding-bottom="{{$padding_bottom ?? ''}}" style="background-color:{{$section_bg ?? ''}}">
    ...
    <div class="container">
        ...
        <div class="row mt-5">
            <div class="col-lg-12">
                <div class="global-slick-init attraction-slider nav-style-one slider-inner-margin" data-appendArrows=".append-testimonial" data-infinite="true" data-arrows="true" data-dots="false" data-slidesToShow="3" data-swipeToSlide="true" data-autoplaySpeed="2500"
                                    ...
                                    <div class="testimonial-item">
                                        <div class="single-testimonial bg-white radius-10">
                                            <div class="single-testimonial-top">
                                                <h4 class="single-testimonial-title"> <a href="javascript:void(0)"> {{ ucfirst($feedback->title) }} </a> </h4>
                                            ...
                                            <div class="single-testimonial-author">
                                                <div class="single-testimonial-author-flex d-flex flex-wrap gap-3">
                                                    ...
                                                    <div class="single-testimonial-author-contents flex-fill">
                                                        <h6 class="single-testimonial-author-contents-title"> <a href="javascript:void(0)">{{ $feedback?->user?->fullname }}</a> </h6>
