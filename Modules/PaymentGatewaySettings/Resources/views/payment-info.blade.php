                    ...
                    <div class="customMarkup__single__item">
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            <form action="{{route('admin.payment.settings.info')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="switch">
                                    <label class="label-title mt-3"><strong>{{__('Enable Force SSL Redirection')}}</strong></label>
                                    <input class="custom-switch" type="checkbox" id="enable_disable_decimal_point" name="enable_disable_decimal_point" @if(!empty(get_static_option('enable_disable_decimal_point'))) checked @endif>
                                    <label class="switch-label" for="enable_disable_decimal_point">{{__('Enable/Disable Decimal Point')}}</label>
                                </div>
                                <div class="single-input">
