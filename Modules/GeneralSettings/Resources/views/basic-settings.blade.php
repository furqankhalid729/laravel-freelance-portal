                        ...
                        <div class="customMarkup__single__inner mt-4">
                            <form action="{{route('admin.general.settings.basic')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="switch mb-3">
                                    ...
                                    <input class="custom-switch" type="checkbox" id="site_google_captcha_enable" name="site_google_captcha_enable" @if(!empty(get_static_option('site_google_captcha_enable'))) checked @endif id="site_google_captcha_enable">
                                ...
                                <div class="switch mb-3">
                                    ...
                                    <input class="custom-switch" type="checkbox" id="site_force_ssl_redirection" name="site_force_ssl_redirection" @if(!empty(get_static_option('site_force_ssl_redirection'))) checked @endif id="site_force_ssl_redirection">
