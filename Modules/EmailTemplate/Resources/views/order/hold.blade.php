...
@section('title', __('Order Hold Email To User'))
@section('style')
                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title">{{ __('Order Hold Email To User') }}</h4>
                        </div>
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            <form action="{{route('admin.order.hold.email')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <x-form.text
                                    :title="__('Email Subject')"
                                    :type="__('text')"
                                    :name="'order_hold_subject'"
                                    :id="'order_hold_subject'"
                                    :value="get_static_option('order_hold_subject') ?? __('Hold Order')"
                                />
                                <x-form.summernote
                                    :title="__('Email Message')"
                                    :name="'order_hold_message'"
                                    :id="'order_hold_message'"
                                    :value="get_static_option('order_hold_message') ?? '' "
                                />
