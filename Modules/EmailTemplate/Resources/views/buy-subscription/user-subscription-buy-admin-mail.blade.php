                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            <form action="{{route('admin.user.subscription.buy.receive.mail')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <x-form.text
                                    :title="__('Email Subject')"
                                    :type="__('text')"
                                    :name="'user_subscription_purchase_admin_email_subject'"
                                    :id="'user_subscription_purchase_admin_email_subject'"
                                    :value="get_static_option('user_subscription_purchase_admin_email_subject') ?? __('User Subscription Purchase Email')"
                                />
                                <x-form.summernote
                                    :title="__('Email Message')"
                                    :name="'user_subscription_purchase_admin_email_message'"
                                    :id="'user_subscription_purchase_admin_email_message'"
                                    :value="get_static_option('user_subscription_purchase_admin_email_message') ?? '' "
                                />
