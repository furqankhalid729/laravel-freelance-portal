...
@section('title', __('User Register Welcome Email'))
@section('style')
                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title">{{ __('User Register Welcome Email') }}</h4>
                        </div>
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            <form action="{{route('admin.user.register.welcome')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <x-form.text
                                        :title="__('Email Subject')"
                                        :type="__('text')"
                                        :name="'user_register_welcome_subject'"
                                        :id="'user_register_welcome_subject'"
                                        :value="get_static_option('user_register_welcome_subject') ?? __('User Register Welcome Email')"
                                />
                                <x-form.summernote
                                        :title="__('Email Message')"
                                        :name="'user_register_welcome_message'"
                                        :id="'user_register_welcome_message'"
                                        :value="get_static_option('user_register_welcome_message') ?? ''"
                                />
