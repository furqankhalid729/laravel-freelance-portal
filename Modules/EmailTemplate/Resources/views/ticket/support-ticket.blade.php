...
@section('title', __('Support Ticket Mail'))
@section('style')
                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title">{{ __('Support Ticket Mail') }}</h4>
                        </div>
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            <form action="{{route('admin.support.ticket.email')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <x-form.text
                                    :title="__('Email Subject')"
                                    :type="__('text')"
                                    :name="'support_ticket_subject'"
                                    :id="'support_ticket_subject'"
                                    :value="get_static_option('support_ticket_subject') ?? __('Support Ticket')"
                                />
                                <x-form.summernote
                                    :title="__('Email Message')"
                                    :name="'support_ticket_message'"
                                    :id="'support_ticket_message'"
                                    :value="get_static_option('support_ticket_message') ?? '' "
                                />
