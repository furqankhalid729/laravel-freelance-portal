    ...
    <div class="profile-wrapper-flex flex-between">
        <div class="profile-wrapper-author">
            <div class="profile-wrapper-author-flex d-flex gap-3">
                <div class="profile-wrapper-author-thumb">
                    @if($user->image)
                        <a href="javascript:void(0)"><img src="{{ asset('assets/uploads/profile/'.$user->image) }}" alt=""></a>
                    @else
            ...
            <div class="promote_profile profile-border-top">
                ...
                @if(moduleExists('PromoteFreelancer'))
                    @php
                        ...
                        $is_promoted = \Modules\PromoteFreelancer\Entities\PromotionProjectList::where('identity',auth()->user()->id)->where('type','profile')->where('expire_date','>',$current_date)->where('payment_status','complete')->first();
                    @endphp
