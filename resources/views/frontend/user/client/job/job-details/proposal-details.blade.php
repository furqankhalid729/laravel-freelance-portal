                            ...
                            <div class="myJob-wrapper">
                                ...
                                @if($proposal_details->attachment)
                                    <div class="myJob-wrapper-single">
                                        ...
                                        <div class="myJob-wrapper-single-contents">
                                            <a href="{{ asset('assets/uploads/jobs/proposal/'.$proposal_details->attachment) }}" download class="single-refundRequest-item-uploads"><i class="fa-solid fa-cloud-arrow-up"></i> {{ $proposal_details->attachment ?? '' }}</a>
                                        </div>
                                    </div>
                                @endif
                            </div>
