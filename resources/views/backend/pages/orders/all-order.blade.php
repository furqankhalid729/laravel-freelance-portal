...
@section('content')
    <div class="dashboard__body">
        <div class="row">
            <div class="col-lg-12">
                <x-notice.general-notice :description="__('Notice: You can manage all orders from here.')" :description1="__('Notice: You can search by id, order type, create date.')" :description2="__('Notice: Order type refers to whether the order was generated from a project or a job.')" :description3="__('Notice: The admin has the ability to update the payment status for transactions that are pending.')" />
