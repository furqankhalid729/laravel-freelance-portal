...
@section('content')
    <div class="dashboard__body">
        <div class="myOrder_single bg-white padding-20 radius-10">
            <div class="row g-4">
                <div class="col-md-12">
                    <x-notice.general-notice :description="__('Notice: If a completed order is canceled by the admin, the order amount will be credited to the client wallet and deducted from the freelancer wallet.')" />
                </div>
