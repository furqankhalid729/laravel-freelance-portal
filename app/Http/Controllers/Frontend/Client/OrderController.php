...
class OrderController extends Controller
{
    ...
    public function request_revision(Request $request)
    {
        ...
        freelancer_notification($request->order_id, $freelancer->freelancer_id, 'Order','Request for revision');

        return back()->with(toastr_success('Revision request successfully created'));
    }
